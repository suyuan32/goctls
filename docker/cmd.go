...
func init() {
	...
	dockerCmdFlags.StringVarPWithDefaultValue(&varStringBase, "base", "a", "alpine:3.21")
	...
	dockerCmdFlags.StringVarPWithDefaultValue(&varStringImage, "image", "i", "golang:1.23.6-alpine3.21")
