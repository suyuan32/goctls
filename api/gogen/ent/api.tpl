...
type (
    ...
    // The response data of {{.modelEnglishName}} list | {{.modelChineseName}}列表数据
    {{.modelName}}ListResp {
        BaseDataInfo

        // The {{.modelEnglishName}} list data | {{.modelChineseName}}列表数据
    ...
    {{.modelName}}InfoResp {
        ...
        // {{.modelEnglishName}} information | {{.modelChineseName}}数据
        Data {{.modelName}}Info `json:"data"`
    }
)
