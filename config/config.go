...
const DefaultGoZeroVersion = "v1.7.4"

// OldGoZeroVersion defines the old version of go zero for update
var OldGoZeroVersion = []string{"v1.6.0", "v1.6.1", "v1.6.2", "v1.6.3", "v1.6.4", "v1.6.5", "v1.6.6", "v1.7.0", "v1.7.1", "v1.7.2", "v1.7.3"}
